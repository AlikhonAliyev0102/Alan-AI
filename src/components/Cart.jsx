...
const Cart = () => {
    ...
    const addCartHandler = (item) =>{
        ...
        toast.dark("Product aded successfully")
    }
    const modalHandler =() => {
        setIsModal(!isModal)
    }
    ...
    useEffect(()=> {
        alanBtn({
            key: 'b0511d0b29e99efa600bfc247d0fc6722e956eca572e1d8b807a3e2338fdd0dc/stage',
                ...
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    {mainCart.map((item)=>(
                        <div key={item.id} className=" col">
                            <div className="card shadow-sm p-3" style={{minHeigth: "550px"}}>
